      ...
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.05)', marginTop: '0' }}>
        ...
        <div className="footer-inner">
          ...
          <nav className="footer-nav">
            {([['/', 'Home'], ['/services', 'Services'], ['/book', 'Book'], ['/gallery', 'Gallery'], ['/reviews', 'Reviews'], ['/policy', 'Policies']] as [string, string][]).map(([href, label]) => (
          ...
          <div className="footer-payments">
            ...
            <a className="footer-pay-chip" href="mailto:jojanylavalle@icloud.com?subject=Zelle%20Payment" style={{ cursor: 'pointer', textDecoration: 'none' }}>
