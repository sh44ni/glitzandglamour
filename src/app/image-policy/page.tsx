        ...
        <div style={{ minHeight: '100vh', padding: '40px 20px 120px', position: 'relative', zIndex: 1 }}>
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gap: '14px' }}>
                    ...
                    <PolicyCard sym="1" icon={<Camera size={18} color="#FFD166" />} title="Optional consent">
                    ...
                    <PolicyCard sym="2" icon={<Shield size={18} color="#06D6A0" />} title="No effect on services">
                    ...
                    <PolicyCard sym="3" icon={<Edit3 size={18} color="#118AB2" />} title="Editing and presentation">
                    ...
                    <PolicyCard sym="4" icon={<Slash size={18} color="#FF2D78" />} title="Restrictions">
                    ...
                    <PolicyCard sym="5" icon={<Award size={18} color="#4FC3F7" />} title="Ownership & copyright">
                    ...
                    <PolicyCard sym="6" icon={<Users size={18} color="#9D4EDD" />} title="Minors">
                    ...
                    <PolicyCard sym="7" icon={<XCircle size={18} color="#FF6B6B" />} title="Withdrawal of consent">
                    ...
                    <PolicyCard sym="8" icon={<Scale size={18} color="#FF6BA8" />} title="Governing law">
